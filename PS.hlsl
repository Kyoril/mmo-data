...
float4 main(VertexOut input) : SV_Target
{
	...
	float4 expr_44 = texparam1.Sample(paramsampler1, expr_43.xy);
	...
	float4 expr_54 = texparam2.Sample(paramsampler2, expr_4.xy);
	...
	float expr_61 = 0.000000;

	float expr_62 = lerp(expr_57, expr_60, expr_61);
	...
	float roughness = saturate(expr_62);
