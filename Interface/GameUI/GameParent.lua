...
-- Inventory Type constants. The item Lua API (item.inventoryType / item:GetInventoryType())
-- returns these string names, not numeric ids.
INVENTORY_TYPE_NONEQUIP = "NON_EQUIP";
...
INVENTORY_TYPE_TWOHANDEDWEAPON = "TWO_HANDED_WEAPON";
INVENTORY_TYPE_BAG = "BAG";
INVENTORY_TYPE_TABARD = "TABARD";
INVENTORY_TYPE_ROBE = "ROBE";
INVENTORY_TYPE_MAINHANDWEAPON = "MAIN_HAND_WEAPON";
INVENTORY_TYPE_OFFHANDWEAPON = "OFF_HAND_WEAPON";
INVENTORY_TYPE_HOLDABLE = "HOLDABLE";
INVENTORY_TYPE_AMMO = "AMMO";
INVENTORY_TYPE_THROWN = "THROWN";
INVENTORY_TYPE_RANGEDRIGHT = "RANGED_RIGHT";
