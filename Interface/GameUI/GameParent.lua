...
INVENTORY_TYPE_WEAPON = 13;
INVENTORY_TYPE_SHIELD = 14;
INVENTORY_TYPE_RANGED = 15;
INVENTORY_TYPE_CLOAK = 16;
INVENTORY_TYPE_TWOHANDEDWEAPON = 17;
INVENTORY_TYPE_BAG = 18;
INVENTORY_TYPE_TABARD = 19;
INVENTORY_TYPE_ROBE = 20;
INVENTORY_TYPE_MAINHANDWEAPON = 21;
INVENTORY_TYPE_OFFHANDWEAPON = 22;
INVENTORY_TYPE_HOLDABLE = 23;
INVENTORY_TYPE_AMMO = 24;
INVENTORY_TYPE_THROWN = 25;
INVENTORY_TYPE_RANGEDRIGHT = 26;
