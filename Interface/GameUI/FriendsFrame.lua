...
FRIEND_COMMAND_RESULTS[2] = "FRIEND_NOT_FOUND"
FRIEND_COMMAND_RESULTS[3] = "FRIEND_SELF"
FRIEND_COMMAND_RESULTS[4] = "FRIEND_ENEMY"
FRIEND_COMMAND_RESULTS[5] = "FRIEND_LIST_FULL"
FRIEND_COMMAND_RESULTS[6] = "FRIEND_TARGET_LIST_FULL"
FRIEND_COMMAND_RESULTS[7] = "FRIEND_INVITE_PENDING"
FRIEND_COMMAND_RESULTS[8] = "FRIEND_SUCCESS"
...
function FriendsFrame_OnInvite(self, inviterName)
    ...
    -- Could show accept/decline dialog here in future
end
...
function FriendsList_SelectFriend(self)
    local friendIndex = self:GetID() + FRIEND_LIST_OFFSET
